...
class PolishAgent(BaseAgent):
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Generate polished image (provider-aware)
        image_provider = generation_utils._infer_provider(self.image_model_name, is_image=True)
        try:
            if image_provider == "gemini":
                ...
                print(f"⚠️  Unsupported image provider '{image_provider}' for PolishAgent. Skipping image generation.")
                return data
